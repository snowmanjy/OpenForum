...
class TenantServiceTest {
    ...
    void getTenant_shouldReturnTenant_whenExists() {
        ...
        Tenant tenant = com.openforum.domain.aggregate.TenantFactory.create(tenantId, Map.of());
    ...
    void updateTenantConfig_shouldUpdate_whenTenantExists() {
        ...
        Tenant existingTenant = com.openforum.domain.aggregate.TenantFactory.create(tenantId, oldConfig);
